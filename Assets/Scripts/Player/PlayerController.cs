...
namespace Player
{
    public class PlayerController : MonoBehaviour
    {
        ...
        {
            Debug.Log("Player entering dialogue mode.");
            FreezePosition(); // Используем твой существующий метод!
        }

        public void ExitDialogueMode()
        {
            Debug.Log("Player exiting dialogue mode.");
            UnfreezePosition(); // И этот тоже!
        }
